...
Traces 15437-16688 of the 20-fold stacked data are used in Paper II.
...
wdir = r'/mn/terra/hubradata/Data2008_09/Wisdom/0402'
file = 'data0'
pro = HUBRA()
...
os.rename(os.path.join(wdir, file + '.h5'),
          os.path.join(wdir, 'AT2009-02-04_pha_stk20.h5'))